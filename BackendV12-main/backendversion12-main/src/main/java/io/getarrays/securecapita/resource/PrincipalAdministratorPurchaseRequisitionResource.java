...
public class PrincipalAdministratorPurchaseRequisitionResource {
    ...
    @PostMapping("/create")
    public ResponseEntity< PrincipalAdministratorPurchaseRequisition> createPrincipalPurchaseRequesition
            (@RequestBody  PrincipalAdministratorPurchaseRequisition principalAdministratorPurchaseRequisition, Authentication authentication) {
        UserDTO user = userService.getUserByEmail(getAuthenticatedUser(authentication).getEmail());
        PrincipalAdministratorPurchaseRequisition createdPrincipalPurchase = principalAdministratorPurchaseRequisitionService.createPrincipalAdministratorPurchaseRequisition
                (principalAdministratorPurchaseRequisition, user.getId());
